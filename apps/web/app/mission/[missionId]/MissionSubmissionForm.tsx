    ...
    <section className="rounded-lg border border-blue-500/30 bg-[#111827] p-5 shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <textarea
          ...
          className="w-full rounded-lg border border-blue-500/30 bg-[#0d1225] p-3 font-mono text-sm text-gray-100 outline-none transition-colors placeholder:text-gray-500 focus:border-cyan-400"
        />
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <button
            type="submit"
            className="rounded-lg border border-cyan-500/30 bg-cyan-500/20 px-4 py-2 text-sm font-medium text-cyan-300 transition-colors hover:border-cyan-400 hover:text-cyan-200"
          >
            Submit Mission
          </button>
          {submitted && (
