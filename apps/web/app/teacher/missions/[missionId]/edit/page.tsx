...
export default function EditMissionPage() {
  ...
  if (user.role !== "teacher") return <Layout title="Edit Mission"><p>Access denied. <Link href="/role" className="text-brand underline">Enter Mission Control</Link>.</p></Layout>;
